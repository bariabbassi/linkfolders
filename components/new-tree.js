...
class Tree extends Component {
  ...
  onTextChange(e) {
    console.log(this.initializedСopy(JSON.parse(e.target.value)))
    this.setState({ nodes: this.initializedСopy(JSON.parse(e.target.value)) });
  }

  nodesToString() {
    return JSON.stringify(this.// import '@/styles/tree.css';// import '@/styles/tree.css';y(this.state.nodes), undefined, 2);
  }
